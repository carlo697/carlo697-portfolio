          ...
          <div className="col color-light-gray">
            <FadeParallax>
              <p className="font-size-5 pb-4">
                ...
                sitio para demostrar mis habilidades y los proyectos en los que
                he trabajado! Puede presionar las siguientes tarjetas para ver
                una lista de las tecnologías que manejo.
              </p>
            </FadeParallax>
          </div>
